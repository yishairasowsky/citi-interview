...
def load_data():
    ...
    train_samples = process_sentences(os.path.join(base_path,'train.txt'))[:sample_limit]
    test_samples = process_sentences(os.path.join(base_path,'test.txt'))[:sample_limit]
    valid_samples = process_sentences(os.path.join(base_path,'valid.txt'))[:sample_limit]
